...
.. note::
   ...
   Clearly, nMigen code that drives a single bit of a signal from two different domains does not describe a well-behaved circuit. However, driving two different bits of a signal from two different domains does not inherently cause such a conflict. Would nMigen accept the following code?
